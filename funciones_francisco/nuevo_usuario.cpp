...
void Guardar(char Nombres[N][100], char Apellidos[N][100], char Dui[N][11], char Numero_cuenta[N][10], char anio[N][11], int& i, char Mes[N][11])
        {
                int mes;
                        ...
                        do{
                                ...
                                gotoxy(5,10);cout<<"\x1b[1;34m1. Enero: ";
                                gotoxy(5,11);cout<<"2. Febrero: ";
                                gotoxy(5,12);cout<<"3. Marzo: ";
                                gotoxy(20,10);cout<<"4. Abril: ";
                                gotoxy(20,11);cout<<"5. Mayo: ";
                                gotoxy(20,12);cout<<"6. Junio: ";
                                gotoxy(40,10);cout<<"7. Julio: ";
                                gotoxy(40,11);cout<<"8. Agosto: ";
                                gotoxy(40,12);cout<<"9. Septiembre: ";
                                gotoxy(60,10);cout<<"10. Octubre: ";
                                gotoxy(60,11);cout<<"11. Noviembre: ";
                                gotoxy(60,12);cout<<"12. Diciembre: \033[0m";
                                gotoxy(5,14);cout<<"\033[1m                                                  \033[0m";
                                gotoxy(5,14);cout<<"Elige el numero que corresponde a el mes: ";
                                ...
                                if((strlen(Mes[i]) <0 || strlen(Mes[i]) >3))
                                        {
                                           gotoxy(20,25);cout<<"\x1b[41;37m* Debe de ingresar 1 o 2 digitos *\033[0m"<<endl;
                                           system("pause>null");
                                           gotoxy(20,25);cout<<"\033[1m                                        \033[0m"; 
                                        }
                                if((mes <= 0 || mes >= 13))
                                        {
                                           gotoxy(20,25);cout<<"\x1b[41;37m* Debe de ingresar numeros entre 1 y 12 *\033[0m"<<endl;
                                           system("pause>null");
                                           gotoxy(20,25);cout<<"\033[1m                                                     \033[0m"; 
                                        }
                         ...
                         do{
                                gotoxy(5,16);cout<<"\033[1m                                                  \033[0m";
                                gotoxy(5,16);cout<<"Numero de DUI: ";
                                gets(Dui[i]);                                
