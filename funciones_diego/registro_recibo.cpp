...
{ /*esta funcion lo que hace es pedir los datos principales
	...
	if (c_usuario[0] != 48)
	{
		do
		{
			...
			color(0);
			gotoxy(16,6);cout << " 01 -> Enero"; gotoxy(48,6);cout<<"02 -> Febrero \n ";
			gotoxy(16,8);cout <<" 03 -> Marzo"; gotoxy(48,8);cout<<"04 -> Abril\n";
			gotoxy(16,10);cout << " 05 -> Mayo"; gotoxy(48,10);cout<<"06 -> Junio \n ";
			gotoxy(16,12);cout <<" 07 -> Julio"; gotoxy(48,12);cout<<"08 -> Agosto\n";
			gotoxy(16,14);cout <<" 09 -> Septiembre"; gotoxy(48,14);cout<<"10 -> Octubre \n";
			gotoxy(16,16);cout <<" 11 -> Noviembre"; gotoxy(48,16);cout<<"12 -> Diciembre \n";
			gotoxy(28, 18);
			cin >> mes;
			mes_n = atoi(mes);
			...
			else
			{
				...
				else
				{
					...
					color(2);
					gotoxy(19, 20);
					cout << "DEBE INGRESAR REGISTROS EN EL MES ANTERIOR" << endl;
					color(0);
					system("pause>null");
					system("cls");
				}
