	...
	do
	{
		...
		//entonces se modificara en el caso contrario no se podra 
		{
			...
			{	
				...
				interfaz(2, 26, 2, 79);
				color(1);
				gotoxy(27,2);cout <<"MODIFICAR  REGISTRO"<<endl;
				color(0);
				gotoxy(8,4);cout <<"Usuario: "<< c_usuario<<endl;
				gotoxy(8,6);cout <<"Nombre: "<< nombres[posicion]<<endl;
				gotoxy(8,8);cout << "Mes:  "<<mes<<endl;
				gotoxy(8,10);cout << "Registro anterior:  "<<registro_user[posicion].registro_anual[1][mes_n]<<endl;
				gotoxy(8,12);cout << "Ingrese el cambio del registro:  ";
								...
								if (anterior < modificar)
									{
									...
									else
										{
											...
											exito = false;
											color(2);
											gotoxy(8,14);cout <<"vuelve a intentarlo"<<endl;
											color(0);
											system("pause>0");
											system("cls");
										}
